...
(defun chatwork-insert-tag-to-contact (contact)
  (interactive (list (completing-read "To: " `(,@chatwork-contacts-name-alist ,@chatwork-contacts-id-alist))))
  (let* ((contact-info (cdr (assoc contact `(,@chatwork-contacts-name-alist ,@chatwork-contacts-id-alist))))
         (account-id (cdr contact-info))
         (name (car contact-info)))
...
(defun chatwork-insert-tag-to-member (member)
  ...
  (let* ((member-info (assoc member chatwork-room-members-alist))
